...
wn = tkinter.Tk() 
wn.title("ARANYA Voice Assistant")
wn.geometry('700x300')
wn.config(bg='LightPink')
  
Label(wn, text='Welcome to meet the Voice Assistant by ARANYA', bg='LightPink',
...
cmdLabel=Label(wn, textvariable=showCommand, bg='LightPink',
